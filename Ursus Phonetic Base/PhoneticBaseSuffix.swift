...
public enum PhoneticBaseSuffix {

    public static let suffixes: [String] = ["zod", "nec", "bud", "wes", "sev", "per", "sut", "let", "ful", "pen", "syt", "dur", "wep", "ser", "wyl", "sun",
    ...
    public static func suffix(forByte byte: UInt8) -> String {
        return suffixes[Int(byte)]
    }

    public static func byte(forSuffix syllable: String) throws -> UInt8 {
